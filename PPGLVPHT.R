...
ex=ENP2[which(ENP1$GROUP=="PPGL" | ENP1$GROUP=="PHT"),]
WHYF=ENP1[which(ENP1$GROUP=="PPGL" | ENP1$GROUP=="PHT"),]
...
PPGLVPHT1=list(mitch, all.BER, checker, checke2, perm1, WHYF, allMC, allCC, plsda.select, splsda.select, perf.plsda.select, tune.splsda.select, rich)
...
PPGLVPHT3=list(mitch, all.BER, checker, checke2, perm1, WHYF, allMC, allCC, cvfit1, rich)
...
PPGLVPHT5=list(mitch, all.BER, perm1, WHYF, allMC, allCC, plsda.select, splsda.select, perf.plsda.select, tune.splsda.select, rich)
...
PPGLVPHT7=list(mitch, all.BER, checker, checke2, perm1, WHYF, allMC, allCC, cvfit1, rich)
...
hay=function(x) {
  {
    folds1=split(sample(which(WHYF$GROUP=="PPGL" & clus==0)), rep(1:f, length=nrow(X[which(WHYF$GROUP=="PPGL" & clus==0),])))
    folds2=split(sample(which(WHYF$GROUP=="PPGL" & clus==1)), rep(1:f, length=nrow(X[which(WHYF$GROUP=="PPGL" & clus==1),])))
...
clus[which(WHYF$GROUP=="PPGL"&WHYF$`CENTER ID`=="FRPA")]=0
clus[which(WHYF$GROUP=="PPGL"&WHYF$`CENTER ID`=="ITPD")]=0
...
PPGLVPHT9=list(mitch, all.BER, checker, checke2, perm1, WHYF, allMC, allCC, plsda.select, splsda.select, perf.plsda.select, tune.splsda.select, rich)
...
PPGLVPHT11=list(mitch, all.BER, checker, checke2, perm1, WHYF, allMC, allCC, cvfit1, rich)
...
PPGLVPHT_GYDRITTU1=list(mitch, all.BER, checker, checke2, perm1, WHYF, allMC, allCC, plsda.select, splsda.select, perf.plsda.select, tune.splsda.select, rich)
...
PPGLVPHT_GYDRITTU3=list(mitch, all.BER, checker, checke2, perm1, WHYF, allMC, allCC, cvfit1, rich)
...
PPGLVPHT_GYDRITTU5=list(mitch, all.BER, checker, checke2, perm1, WHYF, allMC, allCC, plsda.select, splsda.select, perf.plsda.select, tune.splsda.select, rich)
...
PPGLVPHT_GYDRITTU7=list(mitch, all.BER, checker, checke2, perm1, WHYF, allMC, allCC, cvfit1, rich)
